...
function check(memid){
	...
	xmlHttp.open("get","${pageContext.request.contextPath}/member/check/"+memid);
	xmlHttp.send(null);
}
...
<body id="account-login" data-com="pagecommon" data-page-id="100040"
	...
	<div id="login">
		...
		<form id="normal-login-form" action="${pageContext.request.contextPath}/member/register" autocomplete="off"  onsubmit="return confrim(this)" 
			method="post" style="display: block">
			<input type="hidden" id="op" name="op" value="register">
					...
					<dl>
						<dd class="dd-padding kv-line-r">
							<input id="memid"
								...
								placeholder="账户名/Email" name="memid" onkeyup="check(this.value)" value="" required>
						...
						<dd class="dd-padding kv-line-r">
							<input id="memalias" class="input-weak J-input" type="text"
								placeholder="昵称" name="memalias" required />
							<div class="to-del J-to-del" style="display: none"></div>
						</dd>
					</dl>
				</dd>
	...
	<ul class="subline" style="text-align: center;">
        <li><a href="${pageContext.request.contextPath}/member/login">立即登录</a>
    </ul>
</body>
</html>